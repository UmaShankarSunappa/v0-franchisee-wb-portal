...
export default function DashboardHomePage() {
  return (
    <div className="space-y-6 sm:space-y-8">
      {/* Welcome Section */}
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold text-cyan-900 text-balance">
          Welcome to Medplus Franchisee Portal
        </h1>
        <p className="text-sm sm:text-base text-gray-600 mt-2 text-pretty">
          Your trusted partner in retail pharmacy excellence
        </p>
      </div>
